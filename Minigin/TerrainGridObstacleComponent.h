...
namespace dae
{
	...
	{
	public:
		TerrainGridObstacleComponent(const std::shared_ptr<EditableTerrainGridComponent>& spTerrain, 
		...
		void GetInfo(size_t& botLeftCellIdx, size_t& amtRows, size_t& amtCols);
